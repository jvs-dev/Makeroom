...
export function alertThis(message, alert) {
    if (i < 3) {
        i++
        let body = document.querySelector("body")
        body.insertAdjacentHTML("beforeend", `<div class="error" style="margin-bottom: ${i == 0 ? "20px" : `${i * 50}px`}; ${alert == "sucess" ? "background: #4caf50;" : ""}">
